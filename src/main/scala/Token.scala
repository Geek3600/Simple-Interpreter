...
// token类
class Token(val tokenType: String, val tokenValue:String, var lineno: Int = 0, var column: Int = 0)
{   
    def str():String = s"Token($tokenType, $tokenValue, position=${this.lineno}:${this.column})"
